    ...
    return (
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.main_contact_item} data-aos="fade-up" data-aos-delay="50"><Link className={styles.url} href="/resume/web-developer.pdf">Resume (Web Dev)</Link></div>
